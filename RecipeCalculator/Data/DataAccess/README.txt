...
********************************************************************
 ...
 1. Delete the migration script (ex title: 201602162242183_CreateDBWithTestData.cs") from Migrations folder within the DataAccess project if it's present, it's auto generated so don't worry.
 ...
 4. Type or paste: Update-Database
  - press enter - 
